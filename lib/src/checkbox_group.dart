...
class _CheckboxGroupState extends State<CheckboxGroup> {
  ...
  void initState() {
    ...
    for (var i = 0; i < widget.checked.length; i++) {
      _selected.add(i);
    }
  ...
  Widget build(BuildContext context) {
    ...
    for (int i = 0; i < widget.labels.length; i++) {
      Checkbox cb = Checkbox(
        ...
        onChanged:
            (widget.disabled != null && widget.disabled.contains(widget.labels.elementAt(i))) ? null : (bool isChecked) => onChanged(isChecked, i),
